      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{url('assets')}}/images/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{url('assets')}}/images/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{route('log_out')}}" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('product')}}"><i class="fa fa-circle-o"></i>DS Sản Phẩm</a></li>
            <li><a href="{{route('add_product')}}"><i class="fa fa-circle-o"></i>Add Sản Phẩm</a></li>
            <li><a href="{{route('order')}}"><i class="fa fa-circle-o"></i>Đơn Hàng</a></li>
...
<script src="{{url('assets')}}/tinymce/config.js"></script>
